<template>
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap text-muted small px-5">
      ...
      <div>
        <small>Stay consistent 💼 • Keep going 🚀 </small>
        <a class="mx-3" href="https://github.com/SmitaTarawade"
          target="_blank" rel="noopener">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 499.36"
            role="img">
            <title>GitHub</title>
