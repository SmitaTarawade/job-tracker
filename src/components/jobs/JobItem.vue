<template>
    <tr :data-job-id="job?.id" :class="{'focus': job?.id === jobStore.editJobItem?.id}">
        ...
        <td>
            <div class="d-flex">
                ...
                <button class="btn btn-primary btn-sm btn-circle  me-3" @click="jobStore.editJob(job)" title="Edit Job"><i
                        class="bi bi-pencil"></i></button>
                <button class="btn btn-danger btn-sm btn-circle" title="Delete Job" data-bs-toggle="modal" data-bs-target="#deleteModal"><i
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button class="btn btn-danger" data-bs-dismiss="modal" @click="jobStore.removeJob(job?.id)">
                                    Delete
                                </button>
                            </div>
